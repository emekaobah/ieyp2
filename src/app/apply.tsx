...
function Form() {
  return (
    <form className="my-8 p-8 shadow-lg rounded-lg min-h-full max-w-7xl mx-auto bg-white">
      ...
      <div className="flex mx-auto">
        <button className="py-4 items-center justify-center mx-auto bg-orange-300 border rounded-lg w-28 shadow-sm font-bold ">
          Submit
        </button>
      </div>
    </form>
